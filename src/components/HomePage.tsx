        ...
        return (
            <Grid container justify="center" spacing={24}>
                <Grid item xs={12} sm={9} md={6} lg={6}>
                    <Typography color="textPrimary" variant="display3">Welcome</Typography>
                    <Typography>
                    ...
                    <Typography color="textPrimary" variant="display2">Usage</Typography>
                    <Typography>
                    ...
                    <Typography color="textPrimary" variant="display2">Example pages</Typography>
                    <Typography>
